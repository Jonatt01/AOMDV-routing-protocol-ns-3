...
public:
  ...
  void SetPhy (Ptr<WifiPhy> phy, Ptr<WifiPhy> phy_busy, Ptr<WifiPhy> phy_busy2); //Blue
  /*
...
private:
  ...
  void SendRxBusyTone (void); //Blue
  void Wakeup (void); //Blue
  /**
  ...
  void StartDataTxTimers_busy (WifiTxVector dataTxVector); //Blue
  ...
  Ptr<WifiPhy> m_phy_busy, m_phy_busy2; //Blue
  ...
  EventId m_sendRxBusyTone; //Blue
  EventId m_wakeup; //Blue

  Ptr<MpduAggregator> m_mpduAggregator; //!<

  Ptr<Packet> m_currentPacket, m_currentPacket_copy;      //Blue        //!< Current packet transmitted/to be transmitted
  ...
  WifiTxVector dataTxVector_original; //Blue
  WifiPreamble preamble_orignal; //Blue
